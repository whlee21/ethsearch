package io.blocko.ethsearch.repository;

import io.blocko.ethsearch.EthsearchApp;
import io.blocko.ethsearch.config.Constants;
import io.blocko.ethsearch.config.audit.AuditEventConverter;
import io.blocko.ethsearch.domain.PersistentAuditEvent;
...
import static io.blocko.ethsearch.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
