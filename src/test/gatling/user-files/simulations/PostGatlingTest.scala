...
class PostGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Post entity")
        ...
        .repeat(2) {
            ...
            .post("/api/posts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "content":"SAMPLE_TEXT", "ownerId":"SAMPLE_TEXT", "ownerFirstName":"SAMPLE_TEXT", "ownerLastName":"SAMPLE_TEXT", "ownerAccount":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
